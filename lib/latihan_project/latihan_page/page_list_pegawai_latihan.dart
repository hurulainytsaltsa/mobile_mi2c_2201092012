...
import 'package:mi2c_mobile/latihan_project/latihan_page/page_add_pegawai_latihan.dart';
...
import 'package:mi2c_mobile/latihan_project/latihan_page/page_update_pegawai_latihan.dart';
...
class _PageListPegawaiState extends State<PageListPegawai> {
  ...
  Future<List<Datum>> getPegawai() async {
    try {
      final response = await http
          .get(Uri.parse("http://192.168.43.45/edukasi_server/getPegawai.php"));
  ...
  Future<void> deletePegawai(String id) async {
    var url = Uri.parse(
        "http://192.168.43.45/edukasi_server/deletePegawai.php?id=$id");
                                                ...
                                                actions: [
                                                  ...
                                                  TextButton(
                                                    onPressed: () {
                                                      ...
                                                      http.post(
                                                        Uri.parse(
                                                            'http://192.168.43.45/edukasi_server/deletePegawai.php'),
                                                        body: {
                                                          'id': entry.value.id
                                                              .toString()
