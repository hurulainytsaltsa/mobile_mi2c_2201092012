  ...
  Future<List<Datum>?> getBerita() async {
    try {
      ...
      http.Response response = await http
          .get(Uri.parse('http://10.127.241.233/beritaDb/getBerita.php'));
        ...
        actions: [
          ...
          IconButton(onPressed: (){
            setState(() {
              ...
              Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context) => PageLoginApi()), (route) => false);
            });
          },
                            ...
                            children: [
                              Padding(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: Image.network(
                                    'http://10.127.241.233/beritaDb/gambar_berita/${data?.gambarBerita}',
                                    fit: BoxFit.fill,
                                  ),
                                ),
                              ),
